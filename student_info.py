...
class Student_Info:
    def __init__(self, root):
        ...
        #-------------- TITLE --------------
        lbl_title = Label(self.root, text="UNIVERSITY OF ADAMSON", font = ("Times New Roman", 40, "bold"), bg = "navy blue", fg = "white", bd = 4, relief = RIDGE)
        ...
        details_btn = Button(btn_frame, text="DETAILS", width = 22, font = ("Times New Roman", 14, "bold"), bg = "sky blue", fg = "navy blue", bd = 0, cursor = "hand1")
        details_btn.grid(row = 2, column = 0, pady = 1)

        logout_btn = Button(btn_frame, text="ABOUT CREATOR", width = 22, font = ("Times New Roman", 14, "bold"), bg = "sky blue", fg = "navy blue", bd = 0, cursor = "hand1")
